...
variable "root_volume_type" {
  description = "The type of the root EBS volume to attach to the EC2 instance (e.g., gp2, gp3, io1)."
  type        = string
  default     = "gp2"
}

variable "root_volume_size" {
  description = "The size of the EBS volume (in GiB) to attach to the EC2 instance."
  type        = number
  default     = 8
}

variable "rumi_volume_type" {
  description = "The type of the additional EBS volume to attach to the EC2 instance (e.g., gp2, gp3, io1)."
  type        = string
  default     = "gp2"
}
